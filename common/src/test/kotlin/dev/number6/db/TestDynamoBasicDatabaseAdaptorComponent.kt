...
interface TestDynamoBasicDatabaseAdaptorComponent {
    ...
    class FakeDynamoDBMapper(dynamoDB: AmazonDynamoDB) : DynamoDBMapper(dynamoDB) {
        ...
        override fun <T> save(o: T, config: DynamoDBMapperConfig) {
            if (o is ChannelComprehensionSummary) {
                save(o as ChannelComprehensionSummary)
            } else {
                Assertions.fail<Any>("expecting summary but got $o")
            }
        }
