...
open class SlackClientAdaptor(private val client: HttpPort) : SlackPort {
    private val gson = Gson()
    override fun getSlackResponse(url: String, logger: LambdaLogger, body: String): Optional<String> {
    ...
    override fun <T> getSlackResponse(url: String, body: String?, responseType: Class<T>?, logger: LambdaLogger): Optional<T> {
